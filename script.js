...
function createRainingImages() {
    ...
    for (let i = 0; i < 100; i++) { // Adjust the number of images as needed
        ...
        image.style.animationDuration = Math.random() * 2 + 1 + 's'; // Random animation duration
        image.style.animationDelay = Math.random() * 2 + 's'; // Random animation delay
